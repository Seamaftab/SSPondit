        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card shadow-lg border-1 rounded-lg mt-6">
                    ...
                    <a href="#" class="btn btn-outline-info">Add New User</a>
                       	...
                       	<table class="table table-bordered table-striped">
                       		...
                       		<tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('users.show', $user->id) }}" class="btn-sm btn-outline-info"><span class="fa fa-search"></span></a>
                                        <a href="{{ route('users.edit', $user->id) }}" class="btn-sm btn-outline-dark"><span class="fa fa-edit"></span></a>
