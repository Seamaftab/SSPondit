                       	...
                       	<table class="table table-bordered table-striped">
                       		...
                       		<tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('categories.show', ['category' => $category->id]) }}" class="btn-sm btn-outline-info"><span class="fa fa-search"></span></a>
                                        <a href="{{ route('categories.edit', ['category' => $category->id]) }}" class="btn-sm btn-outline-dark"><span class="fa fa-edit"></span></a>
                                        <form method="POST" action="{{ route('categories.destroy', ['category' => $category->id]) }}" class="d-inline">
                                            @csrf
                                            @method('DELETE')
